...
dependencies {
    ...
    intellijPlatform {
        ...
        // PsiClass/PsiField/PsiMethod/PsiType resolution for the source
        // and target classes -- both Java classes AND Kotlin light
        // classes are read through this same API (see PublicMethodCollector
        // precedent in test-scaffold-companion), so this is needed even
        // for the Kotlin-only code paths.
